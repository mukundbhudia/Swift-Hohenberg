...
shInterface::getInitialGuess()
{
  return initialGuess;
}

bool
shInterface::computeF(NOX::LAPACK::Vector& f, 
...
bool
shInterface::computeJacobian(NOX::LAPACK::Matrix<double>& J, 
					     const NOX::LAPACK::Vector & x)
{
  double h = 1.0 / double(n-1);
  double hh = h*h;
...
bool
shInterface::computeShiftedMatrix(
...
void
shInterface::setParams(const LOCA::ParameterVector& p) {
...
void
shInterface::printSolution(const NOX::LAPACK::Vector &x,
